...
from wormhole.a2a.types import (
    SendTaskRequest,
    TaskSendParams,
    Message,
    TaskStatus,
...
from wormhole.a2a.server.task_manager import InMemoryTaskManager
from wormhole.a2a.utils.push_notification_auth import PushNotificationSenderAuth
import wormhole.a2a.server.utils as utils
        ...
        try:
            async for item in self.agent.stream(query, task_send_params.sessionId):
                ...
                if not is_task_complete and not require_user_input:
                    ...
                    message = Message(role="agent", parts=parts)   #注意TaskState.COMPLETED也需要发送Message
    ...
    def _validate_request(
        ...
        if not utils.are_modalities_compatible(
            ...
            logger.warning(
                ...
                OAIAgent.SUPPORTED_CONTENT_TYPES,
            )
