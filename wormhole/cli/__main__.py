...
from wormhole.a2a.client import A2AClient, A2ACardResolver
from wormhole.a2a.types import TaskState, Task, TextPart, FilePart, FileContent
from wormhole.a2a.utils.push_notification_auth import PushNotificationReceiverAuth
...
async def cli(agent, session, history, use_push_notifications: bool, push_notification_receiver: str):
    ...
    if use_push_notifications:
        ...
        await notification_receiver_auth.load_jwks(f"{agent}/.well-known/agent.json")
